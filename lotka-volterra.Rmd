...
# Set some parameter values (these can change - keep it in mind):
#I've changed this parameters
parameters <- c(alpha = .4, beta = 0.5, delta = 0.7, gamma = 3)

# Set the initial condition (prey and predator populations at t = 0).
# Recall: x = prey, y = predator
#I've changed the initial condition
init_cond <- c(x = 8, y = 4)
...
# Plot it! 
#I made the lines a little thicker, they look better when they're thinner than this
ggplot(data = approx_lk_df, aes(x = time, y = population)) +
